...
class TestMathematicsInitialization(unittest.TestCase):
    def setUp(self):
        self.base_dir = "workspace/active/mathematics"

    def test_directories_exist(self):
        directories = [
            "linear", "optimization", "probability", "graphs",
            "ODE", "PDE", "statistics", "info_theory",
    ...
    def test_registries_valid(self):
        registries = ["equation_registry.yaml", "solver_registry.yaml", "symbol_graph.yaml"]
        for r in registries:
