...
## Repo
`~/engineering/workspace/active/secure-rest-api-rbac`
...
## Run Command
`cd ~/engineering/workspace/active/secure-rest-api-rbac && docker compose up -d`

## Modules Used
- [[08_MODULES/jwt-analyzer]]
- [[08_MODULES/rbac-middleware]] (produced)
...
## Brain Links
- [[Architecture]]
- [[03_CORE_KNOWLEDGE/RBAC]]
- [[03_CORE_KNOWLEDGE/Principle of Least Privilege]]
- [[03_CORE_KNOWLEDGE/OAuth2 Scopes]]
