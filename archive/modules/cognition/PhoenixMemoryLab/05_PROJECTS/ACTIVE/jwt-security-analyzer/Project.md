...
## Repo
`~/engineering/workspace/active/jwt-security-analyzer`
...
## Run Command
`cd ~/engineering/workspace/active/jwt-security-analyzer && docker compose up -d`

## Modules Used
- [[08_MODULES/jwt-analyzer]] (produced)
...
## Brain Links
- [[Architecture]]
- [[03_CORE_KNOWLEDGE/JWT Structure]]
- [[03_CORE_KNOWLEDGE/Algorithm Confusion]]
- [[03_CORE_KNOWLEDGE/None Algorithm Attack]]
