...
## Repo
`~/engineering/workspace/active/sqli-detection-tool`
...
## Run Command
`cd ~/engineering/workspace/active/sqli-detection-tool && docker compose up -d`

## Modules Used
- [[08_MODULES/sqli-detector]] (produced)
...
## Brain Links
- [[Architecture]]
- [[03_CORE_KNOWLEDGE/SQL Injection Types]]
- [[03_CORE_KNOWLEDGE/Parameterized Queries]]
- [[03_CORE_KNOWLEDGE/UNION attacks]]
