...
## Repo
`~/engineering/workspace/active/aegis-auth`
...
## Run Command
`cd ~/engineering/workspace/active/aegis-auth && docker compose up -d`
...
## Brain Links
- [[Architecture]]
- [[03_CORE_KNOWLEDGE/Zero Trust Model]]
- [[03_CORE_KNOWLEDGE/Device Trust Score]]
- [[03_CORE_KNOWLEDGE/Continuous Verification]]
