# Project: phishing-url-detector-rules

## One-Liner
Rule-based URL detector.

## Status
IDEA / PLANNING / ACTIVE / BLOCKED / MAINTENANCE / COMPLETED / ARCHIVED / FAILED

## Repo
`~/engineering/workspace/active/phishing-url-detector-rules`
...
## Run Command
`cd ~/engineering/workspace/active/phishing-url-detector-rules && docker compose up -d`

## Modules Used
- [[08_MODULES/phishing-url-detector]] (produced)
...
## Brain Links
- [[Architecture]]
- [[03_CORE_KNOWLEDGE/URL Parsing]]
- [[03_CORE_KNOWLEDGE/Domain Reputation]]
- [[03_CORE_KNOWLEDGE/Feature Engineering]]
