...
## Repo
`~/engineering/workspace/active/network-packet-sniffer`
...
## Run Command
`cd ~/engineering/workspace/active/network-packet-sniffer && docker compose up -d`

## Modules Used
- [[08_MODULES/packet-sniffer]] (produced)
...
- [[03_CORE_KNOWLEDGE/Ethernet Frame]]
- [[03_CORE_KNOWLEDGE/TCP/IP Stack]]
