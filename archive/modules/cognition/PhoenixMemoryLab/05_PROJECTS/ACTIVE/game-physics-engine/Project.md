...
## Repo
`~/engineering/workspace/active/game-physics-engine`
...
## Run Command
`cd ~/engineering/workspace/active/game-physics-engine && docker compose up -d`

## Modules Used
- [[08_MODULES/spatial-partitioning-lib]] (produced)
...
## Brain Links
- [[Architecture]]
- [[03_CORE_KNOWLEDGE/Rigid Body Dynamics]]
- [[03_CORE_KNOWLEDGE/Broad Phase - Narrow Phase Collision]]
- [[03_CORE_KNOWLEDGE/Spatial Partitioning]]
- [[03_CORE_KNOWLEDGE/Object Pooling]]
