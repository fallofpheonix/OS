# Project: port-scanner-mini-nmap
...
## Repo
`~/engineering/workspace/active/port-scanner-mini-nmap`
...
## Run Command
`cd ~/engineering/workspace/active/port-scanner-mini-nmap && docker compose up -d`

## Modules Used
- [[08_MODULES/port-scanner]] (produced)
...
## Brain Links
- [[Architecture]]
- [[03_CORE_KNOWLEDGE/TCP SYN Scanning]]
- [[03_CORE_KNOWLEDGE/Raw Sockets]]
- [[03_CORE_KNOWLEDGE/Service Fingerprinting]]
- [[03_CORE_KNOWLEDGE/Scapy]]
