...
## Repo
`~/engineering/workspace/active/file-integrity-checker`
...
## Run Command
`cd ~/engineering/workspace/active/file-integrity-checker && docker compose up -d`

## Modules Used
- [[08_MODULES/file-integrity]] (produced)
...
## Brain Links
- [[Architecture]]
- [[03_CORE_KNOWLEDGE/SHA-256]]
- [[03_CORE_KNOWLEDGE/Cryptographic Hashing]]
- [[03_CORE_KNOWLEDGE/Tamper Detection]]
