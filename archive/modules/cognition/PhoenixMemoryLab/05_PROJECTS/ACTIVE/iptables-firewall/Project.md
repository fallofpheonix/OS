...
## Repo
`~/engineering/workspace/active/iptables-firewall`
...
## Run Command
`cd ~/engineering/workspace/active/iptables-firewall && docker compose up -d`

## Modules Used
- [[08_MODULES/iptables-manager]] (produced)
...
## Brain Links
- [[Architecture]]
- [[03_CORE_KNOWLEDGE/Netfilter]]
- [[03_CORE_KNOWLEDGE/iptables chains]]
- [[03_CORE_KNOWLEDGE/Packet Filtering]]
- [[03_CORE_KNOWLEDGE/Linux Networking]]
