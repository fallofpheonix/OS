...
## Repo
`~/engineering/workspace/active/ai-phishing-detection`
...
## Run Command
`cd ~/engineering/workspace/active/ai-phishing-detection && docker compose up -d`

## Modules Used
- [[08_MODULES/phishing-url-detector]] (ML upgrade)
...
## Brain Links
- [[Architecture]]
- [[03_CORE_KNOWLEDGE/NLP Feature Engineering]]
- [[03_CORE_KNOWLEDGE/URL Tokenization]]
- [[03_CORE_KNOWLEDGE/Ensemble Classifiers]]
