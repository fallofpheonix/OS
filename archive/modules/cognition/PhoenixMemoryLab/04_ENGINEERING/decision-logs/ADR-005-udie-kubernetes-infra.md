...
---
# ADR-005: Kubernetes for UDIE infrastructure control-plane
...
## Decision
Kubernetes manifests for production control-plane, Docker Compose for local development.
...
- **Bare metal / systemd** — too manual for multi-service control-plane
