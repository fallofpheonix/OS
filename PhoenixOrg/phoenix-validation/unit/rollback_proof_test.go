...
func TestRollbackProofChain(t *testing.T) {
	...
	rollbackAuditOriginal := NewRollbackAudit()

	orchOriginal := &Orchestrator{
	...
	rollbackRecordOriginal := RollbackRecord{
