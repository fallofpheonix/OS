...
*   **Pilot Mapping:** SentinelOS Correlation & IPS Engine (`07_security/ips/`)
...
## 7. Evidence Required
*   Incident alerts in the event bus containing: PID, target file path, calculated entropy score, write rate, and timestamp.
...
*   [07_security/ips/](file:///Users/fallofpheonix/os/07_security/ips/) (IPS blocking logic)
*   [06_ai/anomaly_detection/](file:///Users/fallofpheonix/os/06_ai/anomaly_detection/) (Adaptive anomaly thresholds)
