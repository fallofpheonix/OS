...
- **The "Library-Level Poisoning":** A vulnerability in a deeply transitive, static dependency (e.g., a Go library used by `PheonixKernel`) could provide a root-level exploit that is invisible to our eBPF tracepoints, effectively weaponizing our own security instrumentation.
