...
## Context
Defining the mathematical and algorithmic foundations for detecting ransomware-like behavior (encryption bursts and rename storms) within the SentinelOS telemetry pipeline.
