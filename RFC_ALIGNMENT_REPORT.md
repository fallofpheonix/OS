...
*   **RFC-001B (Anomaly Logic) & RFC-001C (Entropy Engine):** MERGE into RFC-001 as mathematical sub-modules.
*   **RFC-001D (Strategic Containment Game):** RENAME to `RFC-010_stackelberg_containment.md`.
*   **RFC-002 (Event Bus):** KEEP. Required for routing.
...
*   **RFC-005 (Containment Engine):** KEEP. Connects directly to PID Control.
*   **RFC-006 (Process Graph):** KEEP. Critical L4 module.
*   **RFC-007 (Event Normalizer):** KEEP. Prerequisite for RFC-006.
*   **RFC-008 (Simulation Agent):** DEFER until R031 (PID Control) is validated.
