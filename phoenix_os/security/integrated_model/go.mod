module github.com/fallofpheonix/phoenix-os/phoenix_os/security/integrated_model

go 1.25.0

replace phoenix/security/physics => ../physics
replace phoenix/telemetry/entropy_engine => ../../telemetry/entropy_engine_go
replace phoenix/telemetry/process_graphs => ../../telemetry/process_graphs
