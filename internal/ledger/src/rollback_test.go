...
func TestSnapshotRollback(t *testing.T) {
	...
	// 1. Add some entries
	l.AddEntry("E1", "START", 0, []byte("data1"))
	l.AddEntry("E2", "E1", 1, []byte("data2"))

	// 2. Take a checkpoint
	cp1, _ := l.Checkpoint()

	// 3. Add more entries
	l.AddEntry("E3", "E2", 2, []byte("data3"))
	...
	// Note: We don't have a Counter field anymore in the struct definition
	// I saw earlier, wait... let me check the struct again.
	// Ah, it HAS a Counter field!

	l.Counter = 2

	// 6. Add a divergent entry
	l.AddEntry("E3-divergent", "E2", 2, []byte("divergent-data"))
