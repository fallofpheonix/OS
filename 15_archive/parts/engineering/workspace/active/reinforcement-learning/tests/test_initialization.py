...
class TestRLInitialization(unittest.TestCase):
    def setUp(self):
        self.base_dir = "workspace/active/reinforcement-learning"

    def test_directories_exist(self):
        directories = [
            "states", "rewards", "policies", "environments",
    ...
    def test_registries_valid(self):
        registries = ["RL_registry.yaml", "environment_graph.yaml", "reward_maps.yaml", "policy_metrics.yaml"]
        for r in registries:
